...
... | ↯ | ↯ | ↯ with L3 ⊢γ₁ ⊢γ₂ ⊢γ₁′ ⊢γ₂′
    | L7 Σ′ τ₁₂ τ₁₁ τ₁ ε₂₁ ε₁₁
    | L9-1 r₁ r₄
... | ↯ | ↯ | ↯ with L8 ⊢e₁ ⊢e₂ | L10 Σ₂ Σ′ τ₂ | ε₁₃ | delayedΣEq e₁ r₁ ⊢e₁
... | Σ₁≡Σ₂ | ZZ | Z | G with IH′ {v₁ = 𝓋₁} {v₂ = 𝓋₂} {ε₁ = (typeSafety e₂ r₂)} {ε₂ = (typeSafety e₂ r₅)} {s′ = Σ₂ ⨰ Σ′} {Σ′ = Σ′} ((L3′ ⊢γ₁ ⊢γ₂ ⊢γ₁′ ⊢γ₂′ r[γ₁,γ₂])) IH₂ v₁ v₂ (subst[( λ X → ⊢ v₁ ⦂ X )] ZZ ε₁) (subst[( λ X → ⊢ v₂ ⦂ X )] ZZ ε₂) ⟨ r₃ , r₆ ⟩
... | OMG rewrite L0-1 Σ′ | L1 Σ′₁ Σ′
    | L0-3 (Σ′ ⨰ Σ′₁)
    | ZZ | ◇ (L0-9 Σ₁ (mapⱽ (_×[qty]_ sx†₁) Σ₂) Σ′)
    | L0-4′ (Σ₁ ⨰ Σ′) | L0-6 sx†₁ Σ₂ Σ′ | L1 Σ₁ Σ′ | L0-4′ (Σ′ ⨰ Σ′₁) | G = OMG
