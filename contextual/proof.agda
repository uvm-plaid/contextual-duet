...
Goal Σ′₁ ⨰ Σ′ ≡ ((Σ′ ⨰ Σ₁) +[qty] ⟨ 0 ⟩)
e₁ : .Γ ⊢ .e₁ ⦂ ƛ⦂ τ₁ ⇒[ ⟨ 0 ⟩ ∔ sx†₁ ∷ Σ₁ ] τ₂ , zero
⊢e₁ : ⇧ᵗ< ᴢ > τ₁₁ ∷ mapⱽ ⇧ᵗ< ᴢ > ℾ₁ ⊢ e′₂ ⦂ τ₂₁ , sx†₁ ∷ Σ′₁
...
... | ↯ | ↯ | ↯ with L15 ⊢γ₁ ⊢γ₂ ⊢γ₁′ ⊢γ₂′
    | L19 Σ′ τ₁₂ τ₁₁ τ₁ ε₂₁ ε₁₁
    | L21-1 r₁ r₄
... | ↯ | ↯ | ↯ with L20 ⊢e₁ ⊢e₂ | L22 Σ₂ Σ′ τ₂ | ε₁₃
... | Σ₁≡Σ₂ | ZZ | Z with IH′ {v₁ = 𝓋₁} {v₂ = 𝓋₂} {ε₁ = (typeSafety e₂ r₂)} {ε₂ = (typeSafety e₂ r₅)} {s′ = Σ₂ ⨰ Σ′} {Σ′ = Σ′} _ _ IH₂ v₁ v₂ (subst[( λ X → ⊢ v₁ ⦂ X )] ZZ ε₁) (subst[( λ X → ⊢ v₂ ⦂ X )] ZZ ε₂) ⟨ r₃ , r₆ ⟩
... | OMG rewrite L0-1 Σ′
    | L0-3 ((Σ′ ⨰ Σ₁) +[qty] ⟨ 0 ⟩)
    | ZZ | ◇ (L4 Σ₁ (mapⱽ (_×[qty]_ sx†₁) Σ₂) Σ′)
    | L0-4′ (Σ₁ ⨰ Σ′) | L0-6 sx†₁ Σ₂ Σ′ | L5 Σ₁ Σ′  =  OMG
