...
fp {Σ = Σ} {Σ′ = Σ′} ⊢γ₁ ⊢γ₂
  (⊢`λ {Σ₁ = Σe₁} {τ₁ = τ₁} {τ₂} ⊢e) r[γ₁,γ₂]
  .(ƛ⦂ e₁ ∥ γ₁) .(ƛ⦂ e₂ ∥ γ₂)
  (⊢λ {Γ = ℾ₁} {τ₁ = τ₁₁} {τ₂ = τ₂₁} {s = sx†₁} {s′ = s†₁} {Σ = Σ₁} ⊢γ₁′ ⊢e₁ ε₁₁ ε₁₂ ε₁₃)
  (⊢λ {Γ = ℾ₂} {τ₁ = τ₁₂} {τ₂ = τ₂₂} {s = sx†₂} {s′ = s†₂} {Σ = Σ₂} ⊢γ₂′ ⊢e₂ ε₂₁ ε₂₂ ε₂₃)
  ⟨ ⊢`λ {γ = γ₁} {e = e₁} , ⊢`λ {γ = γ₂} {e = e₂} ⟩
...
... | Σ₁≡Σ₂ = ⟨∃ ↯ , ⟨ ⟨ ⟨ ⟨ ↯ , Σ₁≡Σ₂ ⟩ , ↯ ⟩ , ↯ ⟩  , P ⟩ ⟩
  where
    ...
    … | IH with change-Σ-𝒱 ⊢v₃ ⊢v₄ E IH
      | delayedΣEq (⊢`λ {Σ₁ = Σe₁} {τ₁ = τ₁} {τ₂} ⊢e) ((⊢`λ {γ = γ₂} {e = e₂})) ⊢e₂
...
… | ⊢λ {Γ = Γ₁} {τ₁ = τ₁₁} {τ₂ = τ₂₁} {s = sx†₁} {s′ = s†₁} {Σ = Σ′₁} ⊢γ₁′ ⊢e₁ ε₁₁ ε₁₂ ε₁₃
  | ⊢λ {Γ = Γ₂} {τ₁ = τ₁₂} {τ₂ = τ₂₂} {s = sx†₂} {s′ = s†₂} {Σ = Σ′₂} ⊢γ₂′ ⊢e₂ ε₂₁ ε₂₂ ε₂₃
  | ⟨∃ ↯ , ⟨ ⟨ ⟨ ⟨ ↯ , ↯ ⟩ , ↯ ⟩ , ↯ ⟩ , IH′ ⟩ ⟩
  with L18 Σ′ τ₂ τ₂₁ τ₂₂ ε₁₂ ε₂₂
    | L21 r₁
...
... | ↯ | ↯ | ↯ with L15 ⊢γ₁ ⊢γ₂ ⊢γ₁′ ⊢γ₂′
    | L19 Σ′ τ₁₂ τ₁₁ τ₁ ε₂₁ ε₁₁
    | L21-1 r₁ r₄
... | ↯ | ↯ | ↯ with L20 ⊢e₁ ⊢e₂ | L22 Σ₂ Σ′ τ₂ | ε₁₃ | delayedΣEq e₁ r₁ ⊢e₁
... | Σ₁≡Σ₂ | ZZ | Z | G with IH′ {v₁ = 𝓋₁} {v₂ = 𝓋₂} {ε₁ = (typeSafety e₂ r₂)} {ε₂ = (typeSafety e₂ r₅)} {s′ = Σ₂ ⨰ Σ′} {Σ′ = Σ′} ((L15′ ⊢γ₁ ⊢γ₂ ⊢γ₁′ ⊢γ₂′ r[γ₁,γ₂])) IH₂ v₁ v₂ (subst[( λ X → ⊢ v₁ ⦂ X )] ZZ ε₁) (subst[( λ X → ⊢ v₂ ⦂ X )] ZZ ε₂) ⟨ r₃ , r₆ ⟩
... | OMG rewrite L0-1 Σ′ | L5 Σ′₁ Σ′
    | L0-3 (Σ′ ⨰ Σ′₁)
    | ZZ | ◇ (L4 Σ₁ (mapⱽ (_×[qty]_ sx†₁) Σ₂) Σ′)
    | L0-4′ (Σ₁ ⨰ Σ′) | L0-6 sx†₁ Σ₂ Σ′ | L5 Σ₁ Σ′ | L0-4′ (Σ′ ⨰ Σ′₁) | G = OMG
