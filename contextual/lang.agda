...
instantiateΣ/τ Σ (pƛ⦂ τ₁ ∥ s₁ ⇒[ s ∔ Σ′ ] τ₂) = let ⟨ s′ , Σ′ ⟩ = instantiateΣ/Σ Σ Σ′ in pƛ⦂ instantiateΣ/τ Σ τ₁ ∥ s₁ ⇒[ s + s′ ∔ Σ′ ] instantiateΣ/τ Σ τ₂
...
Σ ⟨⟨ pƛ⦂ τ₁ ∥ s ⇒[ a₀ ∔ a ∷ x ] τ₂ ⟩⟩ = pƛ⦂ (Σ ⟨⟨ τ₁ ⟩⟩) ∥ s ⇒[ ((Σ ⨰ x) + a₀) ∔ a ∷ [] ] ⇧ᵗ (⇧ˢ Σ ⟨⟨ τ₂ ⟩⟩)
...
substSx/τ< ι > s (sƛ⦂ τ₁ ∥ s₁ ⇒[ c ∔ Σ ] τ₂) = sƛ⦂ substSx/τ< ι > s τ₁ ∥ s₁ ⇒[  c + s × Σ #[ ꜱ ι ] ∔ ꜱ ι ⊟ Σ  ] substSx/τ< ꜱ ι > s τ₂
substSx/τ< ι > s (pƛ⦂ τ₁ ∥ s₁ ⇒[ c ∔ Σ ] τ₂) = pƛ⦂ substSx/τ< ι > s τ₁ ∥ s₁ ⇒[  c + s × Σ #[ ꜱ ι ] ∔ ꜱ ι ⊟ Σ  ] substSx/τ< ꜱ ι > s τ₂
substSx/τ< ι > s (τ₁ ∥ c₁ ∔ Σ₁ ⊗ c₂ ∔ Σ₂ ∥ τ₂) =
  substSx/τ< ι > s τ₁ ∥ c₁ + s × Σ₁ #[ ι ] ∔ ι ⊟ Σ₁ ⊗ c₂ + s × Σ₂ #[ ι ] ∔ ι ⊟ Σ₂ ∥ substSx/τ< ι > s τ₂
substSx/τ< ι > s (τ₁ ∥ x ∔ x₁ ⊕ x₂ ∔ x₃ ∥ τ₂) = substSx/τ< ι > s τ₁ ∥ {!   !} ∔ {!!} ⊕ {!   !} ∔ {!!} ∥ substSx/τ< ι > s τ₂
