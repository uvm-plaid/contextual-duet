...
postulate
  ...
  typeSafety₂ : ∀ {N} {e : PTerm N} {Γ : Γ[ N ]} {Σ : Σₚ[ N ]} {Σ′ Σ₀ : Σ[ N ]} {γ : γ[ N ]} {τ : τ N} {v} → Γ , Σ₀ ⊢ₚ e ⦂ τ , Σ → γ ⊢ e ⇓ₚ return v → ⊢ v ⦂ Σ′ ⟨⟨ τ ⟩⟩
  ...
  -- essentially p ≤ N∞ + Np
  subsumption₂ : ∀ {N} {τ τ₁ τ₂ : τ N} {r₁ r₂} {p₂ p₃} {Σ′ Σ₁ Σ₁₁ Σ₁₂ : Σ[ N ]} {Σ₂ Σ₃ : Σₚ[ N ]}  → (τ₁ τ[⊔] τ₂) ≡ ⟨ τ ⟩
